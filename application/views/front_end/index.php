                                    ...
                                    <div class="row align-items-center">
                                       ...
                                       <div class="col-xl-7 col-lg-6 col-md-6">
                                          <div class="tp-slider-thumb text-end">
                                             <img src="<?php echo $b->ban_image;?>" alt="slider-img">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="tp-product-category-item text-center mb-40">
                                    <div class="tp-product-category-thumb fix">
                                       <a href="shop-category.html">
                                          <img src="<?php echo $c->cat_image;?>" alt="product-category">
                                       </a>
                                    </div>
                                    <div class="tp-product-category-content">
                                       <h3 class="tp-product-category-title">
                                          <a href="shop-category.html"><?php echo $c->cat_name;?></a>
                                       </h3>
                                       <p>20 Product</p>
                                    </div>
                                 </div>
                                                      ...
                                                      <div class="tp-product-item p-relative transition-3 mb-25">
                                                         <div class="tp-product-thumb p-relative fix m-img">
                                                            <a href="product/<?php echo $p->slug;?>">
                                                               <img src="<?php echo $p->pro_main_image;?>" alt="product-electronic">
                                                            </a>
                                                         ...
                                                         <div class="tp-product-content">
                                                            <div class="tp-product-category">
                                                                <a href="product/<?php echo $p->slug;?>"><?php echo $p->cat_name;?></a>
                                                            </div>
                                                            ...
                                                            <div class="tp-product-price-wrapper">
                                                               <?php if( $p->MRP> $p->selling_price){ ?>
                                                               <span class="tp-product-price old-price">$<?php echo $p->MRP;?></span>
                                                            <?php } ?>
                                                               <span class="tp-product-price new-price">$<?php echo $p->selling_price;?></span>
                                                            </div>
                                                         </div>
                                                      </div>
                                                   </div>
