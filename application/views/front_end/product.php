                  ...
                  <div class="col-xxl-12">
                     <div class="breadcrumb__content p-relative z-index-1">
                        <div class="breadcrumb__list has-icon">
                           ...
                           <span><a href="#"><?php echo $productdetails->cat_name;?></a></span>
                           <span><?php echo $productdetails->pro_name;?></span>
                           <?php 
                              }
                           ?>  
                        </div>
                  ...
                  <div class="row">
                           ...
                           <nav>
                              <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                                 ...
                                 <button class="nav-link" id="nav-5-tab" data-bs-toggle="tab" data-bs-target="#nav-5" type="button" role="tab" aria-controls="nav-5" aria-selected="false">
                                    <img src="assets_front/img/product/details/nav/product-details-nav-5.jpg" alt="">
                                 </button>
                              </div>
                           </nav>
                           <div class="tab-content m-img" id="productDetailsNavContent">
                              <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                                 <div class="tp-product-details-nav-main-thumb">
                                    <img src="<?php echo $productdetails->pro_main_image;?>" alt="">
                                 </div>
                              </div>
                              ...
                              <div class="tab-pane fade" id="nav-5" role="tabpanel" aria-labelledby="nav-5-tab" tabindex="0">
                                 <div class="tp-product-details-nav-main-thumb">
                                    <img src="assets_front/img/product/details/main/product-details-main-5.jpg" alt="">
                                 </div>
                              </div>
                            </div>
                        </div>
                     ...
                     <?php
                        if($this->session->flashdata("errormsg")){
                            ?><span><?php echo $this->session->flashdata("errormsg");?></span><?php
                        }
                                ...
                                <div class="col-xl-5 col-lg-6">
                                    <div class="tp-product-details-wrapper">
                                       <div class="tp-product-details-category">
                                          <span><?php echo $productdetails->cat_name;?></span>
                                       </div>
                                       <h3 class="tp-product-details-title"><?php echo $productdetails->pro_name;?></h3>
               
                                       <!-- inventory details -->
                                       <div class="tp-product-details-inventory d-flex align-items-center mb-10">
                                          <div class="tp-product-details-stock mb-10">
                                             <span><?php if($productdetails->stock>0){ echo "In Stock";} else{ echo "Not Available";} ?></span>
                                          </div>
                                        ...
                                        <p><?php echo $productdetails->highlights;?> </p>
                                       <p><?php echo $productdetails->description;?> <span>See more</span></p>
               
                                       <!-- price -->
                                       <div class="tp-product-details-price-wrapper mb-20">
                                          <span class="tp-product-details-price old-price">$<?php echo $productdetails->MRP;?></span>
                                          <span class="tp-product-details-price new-price">$<?php echo $productdetails->selling_price;?></span>
                                       </div>
               
                                     
               
                                       <!-- actions -->
                                       <form action="CartController/addtoCart" method="POST">
                                       <div class="tp-product-details-action-wrapper">
                                         ...
                                         <input name="pro_id" class="" type="hidden" value="<?php echo $productdetails->pro_id;?>">
                                    </form>
                                       ...
                                       <div class="tp-product-details-payment d-flex align-items-center flex-wrap justify-content-between">
                                          ...
                                          <img src="assets_front/img/product/icons/payment-option.png" alt="">
                                       </div>
                                    </div>
                                 </div>
                           <?php
                                       ...
                                       <div class="col-xl-10">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                   <div class="tp-product-details-desc-thumb">
                                                      <img src="assets_front/img/product/details/desc/product-details-desc-1.jpg" alt="">
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="tp-product-details-desc-item  pb-75">
                                             <div class="row">
                                                ...
                                                <div class="col-lg-7">
                                                   <div class="tp-product-details-desc-thumb">
                                                      <img src="assets_front/img/product/details/desc/product-details-desc-2.jpg" alt="">
                                                   </div>
                                                </div>
                                             ...
                                             <div class="row">
                                                <div class="col-xl-12">
                                                   <div class="tp-product-details-desc-banner text-center m-img">
                                                      ...
                                                      <img src="assets_front/img/product/details/desc/product-details-desc-3.jpg" alt="">
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                             ...
                                             <div class="tp-product-details-review-list pr-110">
                                                ...
                                                <div class="tp-product-details-review-avater d-flex align-items-start">
                                                   <div class="tp-product-details-review-avater-thumb">
                                                      <a href="#">
                                                         <img src="assets_front/img/users/user-3.jpg" alt="">
                                                      </a>
                                                   </div>
                                                ...
                                                <div class="tp-product-details-review-avater d-flex align-items-start">
                                                   <div class="tp-product-details-review-avater-thumb">
                                                      <a href="#">
                                                         <img src="assets_front/img/users/user-2.jpg" alt="">
                                                      </a>
                                                   </div>
                                                   <div class="tp-product-details-review-avater-content">
                                                      <div class="tp-product-details-review-avater-rating d-flex align-items-center">
                        ...
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                    <a href="product-details.html">
                                       <img src="assets_front/img/product/related/product-related-1.jpg" alt="">
                                    </a>
                           ...
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                    <a href="product-details.html">
                                       <img src="assets_front/img/product/related/product-related-2.jpg" alt="">
                                    </a>
                                    ...
                                    <div class="tp-product-action-3 tp-product-action-4 has-shadow tp-product-action-primaryStyle">
                                       <div class="tp-product-action-item-3 d-flex flex-column">
                                          <button type="button" class="tp-product-action-btn-3 tp-product-add-cart-btn">
                                             ...
                                             <span class="tp-product-tooltip">c</span>
                                          </button>
                                          <button type="button" class="tp-product-action-btn-3 tp-product-quick-view-btn" data-bs-toggle="modal" data-bs-target="#producQuickViewModal">
                                             <svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.99948 5.06828C7.80247 5.06828 6.82956 6.04044 6.82956 7.23542C6.82956 8.42951 7.80247 9.40077 8.99948 9.40077C10.1965 9.40077 11.1703 8.42951 11.1703 7.23542C11.1703 6.04044 10.1965 5.06828 8.99948 5.06828ZM8.99942 10.7482C7.0581 10.7482 5.47949 9.17221 5.47949 7.23508C5.47949 5.29705 7.0581 3.72021 8.99942 3.72021C10.9407 3.72021 12.5202 5.29705 12.5202 7.23508C12.5202 9.17221 10.9407 10.7482 8.99942 10.7482Z" fill="currentColor"/>
                           ...
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                    <a href="product-details.html">
                                       <img src="assets_front/img/product/related/product-related-3.jpg" alt="">
                                    </a>
                           ...
                           <div class="swiper-slide">
                              <div class="tp-product-item-3 tp-product-style-primary mb-50">
                                 <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                                    <a href="product-details.html">
                                       <img src="assets_front/img/product/related/product-related-4.jpg" alt="">
                                    </a>
                              ...
                              <div class="tp-footer-contact">
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    ...
                                    <div class="tp-footer-contact-content">
                                       <p><a href="https://html.weblearnbd.net/cdn-cgi/l/email-protection#e4978c8b829da4979194948b9690ca878b89"><span class="__cf_email__" data-cfemail="35465d5a534c75464045455a47411b565a58">[email&#160;protected]</span></a></p>
                                    </div>
                                 </div>
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    <div class="tp-footer-contact-icon">
