...
<!-- Mirrored from html.weblearnbd.net/shofy-prv/shofy/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Oct 2023 08:19:24 GMT -->
<head>
      <meta charset="utf-8">
                  ...
                  <div class="col-xl-6 col-lg-8">
                     <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                           ...
                           <p>Already have an account?  <span><a href="<?php echo base_url();?>LoginController">Sign In</a></span></p>
                        </div>
                        <form action="" method="POST">
                           <div class="tp-login-option">
                              ...
                              <div class="tp-login-input-wrapper">
                                 ...
                                 <div class="tp-login-input-box">
                                    <div class="tp-login-input">
                                       <input id="tp_password" type="password" placeholder="Enter Your Password" name="password">
                              ...
                              <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                                 <div class="tp-login-remeber">
                                    <input id="remeber" type="checkbox" name="acceptance" value="1">

                                    <label for="remeber">I accept the terms of the Service & <a href="#">Privacy Policy</a>.</label>
                                    <?php echo form_error('acceptance'); ?>
                                 </div>
                              </div>
