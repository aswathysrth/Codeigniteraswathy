         ...
         <div class="cartmini__wrapper d-flex justify-content-between flex-column">
             ...
             <div class="cartmini__checkout">
                 ...
                 <div class="cartmini__checkout-btn">
                     <a href="<?php echo base_url();?>CartController/cart" class="tp-btn mb-10 w-100"> view cart</a>
                           ...
                           <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                            s
                              <div class="tp-header-top-menu-item tp-header-setting">
                                 ...
                                 <ul>
                                    <li>
                                       <a href="<?php echo base_url();?>LoginController">My Profile</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                       <a href="<?php echo base_url();?>LogoutController">Logout</a>
                                    </li>
                                 <?php } ?>
                                 </ul>
                              </div>
                     ...
                     <div class="col-xl-4 col-lg-3 col-md-8 col-6">
                        <div class="tp-header-main-right d-flex align-items-center justify-content-end">
                           <div class="tp-header-login d-none d-lg-block">
                              <a href="<?php echo base_url();?>LoginController" class="d-flex align-items-center">
                                 ...
                                 <div class="tp-header-login-content d-none d-xl-block">
                                    <span>Hello,<?php if(!empty($this->session->userdata('login_id'))){ echo $this->session->userdata('username'); }else{?> Sign In<?php } ?>
                                    ...
                                    <?php
                                        if($parentcategory){
                                          foreach ($parentcategory as $pc) {
                                               $subcategory=$this->categorymodel->getSubCategory($pc->cat_id);

                                             ?>
                                              <li <?php if($subcategory){ ?>class="has-dropdown" <?php } ?>>
                                                  <a href="shop.html" >
                                                     <span>
                                                    ...
                                                    <?php echo $pc->cat_name;?></a>
                                                    <?php
                                                       
                                                         if( $subcategory){//print_r($subcategory);exit;
                                                            ?>
                                                                        ...
                                                                        ?>
                                                                            <li>
                                                                                <ul>
                                                                                   ...
                                                                                   <li>
                                                                                      <a href="shop.html"> <?php echo $sc->cat_name;?></a>
                                                                                   </li>
