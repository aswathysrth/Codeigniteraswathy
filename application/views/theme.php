...
<!-- Mirrored from landing.zytheme.com/vero/landing-lead-img.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Oct 2023 14:48:12 GMT -->
<head>
	<!-- Document Meta
    ============================================= -->
	<meta charset="utf-8">
	...
	<!-- Document Title
    ============================================= -->
	<title>Vero | Marketing Html5 Landing Page</title>
</head>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<a class="logo" href="index.html">
							<img class="logo-dark" src="<?php echo base_url().'assets/images/logo/logo-dark.png' ;?>" alt="Vero Logo">
							<img class="logo-light" src="<?php echo base_url().'assets/images/logo/logo-light.png'; ?>" alt="Vero Logo">
						</a>
					</div>
		...
		<section id="slider" class="section slider slider-form">
			<div class="slide--item bg-overlay bg-overlay-dark">
				<div class="bg-section">
					<img src="<?php echo base_url().'assets/images/background/bg-5.jpg';?>" alt="bg">
				</div>
				<div class="container">
					<div class="row row-content">
						<div class="col-xs-12 col-sm-6 col-md-5 pt-100">
							<div class="slide--headline">Creating your marketing landing</div>
							<div class="slide--bio">This should be used to tell a story app benefits & more to present project.This should be used to tell a story and let your users know.</div>
							<div class="slide--video">
								<a class="btn--video popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"><i class="fa fa-play"></i>Watch Overview</a>
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-2">
							<div class="slide--action">
								<h6>Get free updates</h6>
								...
								<form class="mb-0">
									...
									<div>
										<input type="submit" class="btn btn--primary btn--block mt-10" value="signup me now">
									</div>
								</form>
							</div>
						</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-6 wow fadeInUp">
						<img class="img-responsive" src="<?php echo base_url().'assets/images/background/bg-2.jpg'; ?>" alt="device"/>
					</div>
					<!-- .col-md-6 end -->
		...
		<section id="feature3" class="section feature feature-2">
			<div class="container">
				<div class="row">
					...
					<!-- .col-md-6 end -->
					<div class="col-xs-12 col-sm-6 col-md-6 wow fadeInUp">
						<img class="img-responsive pull-right" src="<?php echo base_url().'assets/images/background/bg-3.jpg';?>" alt="device"/>
					</div>
					<!-- .col-md-6 end -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-6">
						...
						<div class="testimonial-panel wow fadeInUp" data-wow-duration="1s">
							<div class="testimonial--img">
								<img src="<?php echo base_url().'assets/images/testimonials/1.png';?>" alt="author">
							</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-6">
						...
						<div class="testimonial-panel wow fadeInUp" data-wow-duration="1s">
							<div class="testimonial--img">
								<img src="<?php echo base_url().'assets/images/testimonials/2.png';?>" alt="author">
							</div>
							<div class="testimonial--body">
								<div class="testimonial--author">
									<h5>Jessy Arthur</h5>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="carousel carousel-dots" data-slide="5" data-slide-res="2" data-autoplay="false" data-nav="false" data-dots="false" data-space="30" data-loop="true" data-speed="800">
							<!-- Client #1 -->
							<div class="client">
								<img class="center-block" src="<?php echo base_url().'assets/images/clients/1.jpg';?>" alt="client">
							</div>

							<!-- Client #2 -->
							<div class="client">
								<img class="center-block" src="<?php echo base_url().'assets/images/clients/2.jpg';?>" alt="client">
							</div>

							<!-- Client #3 -->
							<div class="client">
								<img class="center-block" src="<?php echo base_url().'assets/images/clients/3.jpg';?>" alt="client">
							</div>

							<!-- Client #4 -->
							<div class="client">
								<img class="center-block" src="<?php echo base_url().'assets/images/clients/4.jpg';?>" alt="client">
							</div>

							<!-- Client #5 -->
							<div class="client">
								<img class="center-block" src="<?php echo base_url().'assets/images/clients/5.jpg'?>" alt="client">
							</div>
							<!-- Client #3 -->
							<div class="client">
								<img class="center-block" src="<?php echo base_url().'assets/images/clients/3.jpg'?>" alt="client">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
						...
						<a class="btn btn--primary" href="#">get start now</a>
					</div>
					<!-- .col-md-12 end -->
				</div>
				<!-- .row end -->
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<div class="footer--copyright text-center">
							<span>&copy; 2017 Vero, crafted With <i class="fa fa-heart"></i> by</span> <a href="http://themeforest.net/user/zytheme/portfolio?ref=zytheme">zytheme.com</a>
						</div>
					</div>
					<!-- .col-md-6 end -->
				</div>
...
<!-- Mirrored from landing.zytheme.com/vero/landing-lead-img.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 08 Oct 2023 14:48:19 GMT -->
</html>